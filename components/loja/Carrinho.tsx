...
export default function Carrinho({
  ...
  const hasDeliveryAddress = useMemo(
    () => !isDeliveryAddressEmpty({ cep, logradouro, numero, bairro, cidade, uf }),
          ...
          <div className="px-4 sm:px-6 py-5 border-t border-border bg-surface shrink-0 pb-[max(1.25rem,env(safe-area-inset-bottom))]">
            {step === 'cart' ? (
              ...
              <button
                ...
                disabled={hasDeliveryAddress && deliveryQuote.outOfZone}
              ...
              <button
                ...
                disabled={loading || (hasDeliveryAddress && deliveryQuote.outOfZone)}
