...
export const THEME_TYPOGRAPHY: Record<ThemeName, ThemeTypography> = {
  ...
  flash: {
    ...
    fsParcela: '0.6875rem',
    lhParcela: '1.25',
    fsVariantColor: '0.75rem',
    fsBadge: '0.6875rem',
    fsSection: '1rem',
    fsSectionSm: '1.0625rem',
    fsSectionMd: '1.125rem',
    lhSection: '1.2',
    fsFilter: '0.8125rem',
    fsSearch: '0.875rem',
    fsModalTitle: '1.25rem',
    lhModalTitle: '1.2',
    fsModalBody: '0.9375rem',
    lhModalBody: '1.45',
    fsModalBtn: '0.9375rem',
  },
  casual: {
    fsNome: '0.9375rem',
    lhNome: '1.35',
  ...
  social: {
    ...
    fsPreco: '0.8125rem',
    lhPreco: '1.2',
    fsPrecoOld: '0.6875rem',
    fsParcela: '0.6875rem',
    lhParcela: '1.25',
    fsVariantColor: '0.6875rem',
    fsBadge: '0.6875rem',
    fsSection: '1rem',
    fsSectionSm: '1.0625rem',
    fsSectionMd: '1.125rem',
